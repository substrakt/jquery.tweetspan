=== jQuery.tweetspan ===
Contributors: substrakt
Tags: twitter, jquery, tweetspan
...
have to enter or change these details for every site you deploy the plugin

== Writing your own HTML ==

If you don't want to use the widget, a simple HTML example would work like this:
